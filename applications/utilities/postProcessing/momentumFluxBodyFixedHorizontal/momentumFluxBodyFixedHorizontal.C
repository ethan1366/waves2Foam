...
#include "IOsampledmomentumFluxBodyFixedHorizontal.H"
...
#   include "readWaveProperties.H"
    ...
    fileName dict("momentumFluxBodyFixedHorizontalDict");
#else
    fileName dict("system/momentumFluxBodyFixedHorizontalDict");
#endif

    IOsampledmomentumFluxBodyFixedHorizontal sSets
    (
        sampledmomentumFluxBodyFixedHorizontal::typeName,
        mesh,
        dict,
        IOobject::MUST_READ,
        true
