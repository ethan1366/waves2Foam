...
template <class Type>
Foam::sampledmomentumFluxBodyFixedHorizontal::volFieldSampler<Type>::volFieldSampler
(
...
template<class Type>
Foam::label Foam::sampledmomentumFluxBodyFixedHorizontal::grep
(
...
template<class T>
void Foam::sampledmomentumFluxBodyFixedHorizontal::combineSampledValues
(
